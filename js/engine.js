...
function initDemoSite() {
    ...
    // If we are coming from google One Tap login we do the notify
...
function loadOneTapGoogle (){

    // Initializing the object
    
    // Client ID: 157999256223-a0sh9tvk26t3f4qo8mqcnlvf70gd1gio.apps.googleusercontent.com
    // Client Secret: P-e-ugxcZ5_0rLJYOUD54N7_

    console.log('Loading One Tap Google...');
                  ...
                  var googleAuth = gapi.auth2.init({
                    ...
                    if(GoogleUser.isSignedIn()){
                      ...
                      function onAfterDelegate(name,photo){
                        ...
                        //Hide the screenSet
                        gigya.accounts.hideScreenSet({screenSet:"Default-RegistrationLogin"});
                        //Call to notifyLogin
                        NotifyLoginCall();
